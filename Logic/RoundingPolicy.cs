namespace Logic
{
    public class RoundingPolicy
    {
        ...
        public RoundingPolicy() : this(RoundingStrategy.Common) { }

        public RoundingPolicy(RoundingStrategy s, sbyte decimals = 2, byte digit = 5,
            double step = 0.1)
        {
            strategy = s;
        ...
        {
            get { return step; }
            set { step = validateStep(value); }
        }
        public sbyte Decimals
        {
            get { return decimals; }
            set { decimals = validateDecimals(value); }
        }
        public byte Digit
        {
            get { return digit; }
            set { digit = validateDigit(value); }
        }       
    }
}
